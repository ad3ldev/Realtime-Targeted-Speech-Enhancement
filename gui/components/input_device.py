...
class InputDeviceComponent:
    ...
    def create_input_device_dropdown(self):
        ...
        self.input_device_label.place(
            relx=op.InputDevice_Label_relx,
            rely=op.InputDevice_Label_rely,
            anchor=op.InputDevice_Label_anchor,
        )
        self.input_device_dropdown.place(
            relx=op.InputDevice_Dropdown_relx,
    ...
    def adjust_combobox_width(self, event):
        new_width = int(
            self.root.winfo_width() * 0.12
        )  # Adjust 0.5 to the desired percentage
