...
class NoiseSuppressionComponent:
    ...
    def create_switch(self):
        ...
        self.switch.place(
            relx=op.NoiseSuppression_switch_relx,
    ...
    def create_slider(self):
        ...
        self.slider = ttk.Scale(
            ...
            to=100,
            orient="horizontal",
            variable=self.dry_set_slider_value,
        ...
        self.slider_frame.pack(
            fill="x", side="bottom", pady=op.NoiseSuppression_slider_pady
        )
    ...
    def slider_changed(self, event):
        new_value = self.round_to_nearest_multiple_of_step(
            int(self.get_current_value()[:-1]), 5
        )
        self.current_value_label.configure(
            text=str(new_value) + "%"
        )  # change the 5 for different step
