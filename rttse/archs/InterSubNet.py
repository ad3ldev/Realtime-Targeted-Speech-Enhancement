...
from InterSubNet.InterSubNetBase import BaseModel
from InterSubNet.SIL_Block import stacked_SIL_blocks_SequenceModel
from utils.acoustics.feature import drop_band

# for log
# from utils.logger import get_root_logger

# print = get_root_logger().info
...
if __name__ == "__main__":
    ...
    import torchinfo
    torchinfo.summary(model, input_size=(1, 1, 257, 1000))

    input_data = torch.ones((1, 1, 257, 1000))
    output = model(input_data)
    print(output.shape)
    torch.autograd.set_detect_anomaly(True)
    y = torch.rand((1, 1, 257, 1000))
