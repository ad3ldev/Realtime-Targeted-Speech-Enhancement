...
\begin{itemize}
    ...
    \item \textbf{Padding:} Controls how the input edges are handled. Padding with zeros or mirrored values maintain the output size while mitigating information loss at the edges (Figure \ref{fig:cnn-padding}).
