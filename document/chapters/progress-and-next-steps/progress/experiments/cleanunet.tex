...
The model was trained on a 2 NVIDIA Tesla T4 GPUs. The training took 24 hours to complete. The training loss is shown in Figure \ref{fig:cleanunet-training} and metrics on the test set are shown in Table \ref{tab:cleanunet-test}.
