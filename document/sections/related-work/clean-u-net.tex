\subsection{CleanUNet \cite{kong2022}}
...
Results:
\begin{itemize}
    \item CleanUNet bet all baseline architectures in all metrics.
...
Results:
\begin{itemize}
    \item CleanUNet bet FAIR-denoiser in all metrics.
\end{itemize}
...
Results:
\begin{itemize}
    \item CleanUNet bet both FullSubNet and FAIR-denoiser in all metrics.
\end{itemize}